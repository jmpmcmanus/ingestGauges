...
df = addNOAAMeta(dirpath,noaafile)
df.to_csv(dirpath+'geom_'+noaafile, index=False)
...
df = addNCEMMeta(dirpath,contrailfile, adcircfile)
df.to_csv(dirpath+'geom_'+contrailfile, index=False)
